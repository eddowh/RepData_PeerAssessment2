...
### Row Filter
The numeric values which will help conclude the answers to the questions posed will only be useful when it is quantified above zero, so certain rows will be filtered out from the data.
```{r}
