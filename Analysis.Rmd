...
topDamage
```
The corrected data makes much more sense now, with the top 10 damages responsible for **`r sum(topDamage$Percent_Damage)`%** of total damages, and hurricanes accounting for **`r topDamage$Percent_Damage[1]`%**.
