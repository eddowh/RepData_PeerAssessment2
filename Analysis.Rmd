...
```{r}
##  remove rows with no fatalities + injuries and confirm
newStorm <- newStorm[with(newStorm, FATALITIES>0 & INJURIES>0),]
...
##  remove rows with no property + crop damage and confirm
newStorm <- newStorm[with(newStorm, PROPDMG>0 & CROPDMG>0),]
